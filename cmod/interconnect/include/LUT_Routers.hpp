...
#ifndef __LUT_ROUTERS_H__
#define __LUT_ROUTERS_H__
 ...
 * \tparam NoC2Dests         Indicates the destination for hierarchical LUT
 * routing (1st level)
 * \tparam NoCDests         Indicates the destination for hierarchical LUT
 * routing (2nd level)
 * \tparam NoCMCastDests    Indicates the multi-cast destination for
 * hierarchical LUT routing
 ...
 *      ...
 *
 *        typedef WHVCRouter<kNumLPorts, kNumRPorts, kNumVChannels, kBufferSize,
 * kNumMaxHops, SourceRouting>::Flit_t Flit_t;
 *        WHVCRouter<kNumLPorts, kNumRPorts, kNumVChannels, kBufferSize,
 * kNumMaxHops, SourceRouting, 0, 0, 0, Flit_t> router;
 *
